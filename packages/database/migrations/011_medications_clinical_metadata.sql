-- Standard clinical row metadata + soft delete on soma_ehr.medications (see snippets/clinical_row_standard.sql).
...
DROP INDEX IF EXISTS soma_ehr.idx_medications_org_patient;
DROP INDEX IF EXISTS soma_ehr.idx_medications_org_patient_active;
DROP INDEX IF EXISTS soma_ehr.idx_medications_org_updated;
